...
public class SortTypeUI implements ListDiffInterface<SortTypeUI> {  // имплементирую интерфейс
    ...
    @Override
    public boolean theSameAs(SortTypeUI sortTypeUI) {  // реализую метод theSameAs()
