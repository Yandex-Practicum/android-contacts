...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<ContactUi> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<ContactUi>()).build() // заменить создание его экземпляра при инициализации объекта
    );
    ...
    /*static class ListDiffCallback extends DiffUtil.ItemCallback<ContactUi> { // удаляю ненужный класс
