...
public class SortTypeAdapter extends RecyclerView.Adapter<SortTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<SortTypeUI> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<SortTypeUI>()).build() // заменить создание его экземпляра при инициализации объекта
    );
   ...
   /* static class ListDiffCallback extends DiffUtil.ItemCallback<SortTypeUI> { // удаляю ненужный класс
