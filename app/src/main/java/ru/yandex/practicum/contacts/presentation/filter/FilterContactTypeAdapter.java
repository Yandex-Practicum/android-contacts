...
public class FilterContactTypeAdapter extends RecyclerView.Adapter<FilterContactTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<FilterContactTypeUi> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new ru.yandex.practicum.contacts.presentation.base.BaseListDiffCallback<FilterContactTypeUi>()).build()
    );
    ...
    static class BaseListDiffCallback<FilterContactTypeUI> extends DiffUtil.ItemCallback<FilterContactTypeUi> {
