...
public class FilterContactTypeAdapter extends RecyclerView.Adapter<FilterContactTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<FilterContactTypeUi> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<FilterContactTypeUi>()).build() // заменить создание его экземпляра при инициализации объекта
    );
    ...
    /*static class ListDiffCallback extends DiffUtil.ItemCallback<FilterContactTypeUi> { // удаляю ненужный класс
