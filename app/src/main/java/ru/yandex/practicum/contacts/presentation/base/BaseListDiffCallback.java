...
public class BaseListDiffCallback<BaseListDiffCallback extends ListDiffInterface<BaseListDiffCallback>> extends
        DiffUtil.ItemCallback<BaseListDiffCallback> {
