...
public class FilterContactTypeUi implements ListDiffInterface<FilterContactTypeUi> { // имплементирую интерфейс
    ...
    @Override
    public boolean theSameAs(FilterContactTypeUi filterContactTypeUi) {     // реализую недостающий метод
