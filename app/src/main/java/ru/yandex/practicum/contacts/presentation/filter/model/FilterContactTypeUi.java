...
import ru.yandex.practicum.contacts.presentation.base.ListDifInterface;

public class FilterContactTypeUi implements ListDifInterface<FilterContactTypeUi> {
    ...
    @Override
    public boolean theSameAs(FilterContactTypeUi a) {
        return this.getContactType() == a.getContactType();
    }
