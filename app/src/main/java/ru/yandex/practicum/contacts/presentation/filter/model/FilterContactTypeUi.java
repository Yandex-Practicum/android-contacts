...
/// Шаг 2. Реализация интерфейса  FilterContactTypeUi и theSameAs()
    @Override
    public boolean theSameAs(FilterContactTypeUi t_same)
    {
        return this.getContactType() == t_same.getContactType();
    }
