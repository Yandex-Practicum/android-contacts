...
//public class ContactUi {
    public class ContactUi implements ListDiffInterface<ContactUi> { // имплементируем интерфейс
    ...
    @Override
    public boolean theSameAs(ContactUi contactUi) {         // реализую недостающий метод
